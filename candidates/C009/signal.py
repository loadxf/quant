...
from quantlab import REPO_ROOT

SECTOR_TO_ETF = {
    "Materials": "XLB", "Communication Services": "XLC", "Energy": "XLE",
    "Financials": "XLF", "Industrials": "XLI", "Information Technology": "XLK",
...
def compute_signal(fields: dict[str, pd.DataFrame]) -> pd.DataFrame:
    ...
    for ticker in adj.columns:
        etf = SECTOR_TO_ETF.get(sectors.get(ticker, ""), None)
